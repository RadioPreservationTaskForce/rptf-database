...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.index.title_field = 'collectionTitle_txt'
    ...
    config.add_facet_field 'collectionOwnerNameFacet', label: 'Repository/Collector', limit: 25
    config.add_facet_field 'collectionOwnerLocationCountryFacet', label: 'Country (Location)', limit: 25
    config.add_facet_field 'collectionOwnerLocationStateFacet', label: 'State (Location)', limit: 25
    ...
    config.add_index_field 'collectionDescription_txt', label: 'Description'
    config.add_index_field 'collectionContentTypes_txt', label: 'Content types', link_to_search: 'collectionContentTypesFacet'
    ...
    config.add_show_field 'collectionOwnerName_txt', label: 'Repository/Collector', link_to_search: 'collectionOwnerNameFacet'
    config.add_show_field 'collectionOwnerCategory_txt', label: 'Repository/Collector Type'
    config.add_show_field 'collectionOwnerLocationCity_txt', label: 'City'
    config.add_show_field 'collectionOwnerLocationState_txt', label: 'State'
    config.add_show_field 'collectionOwnerLocationCountry_txt', label: 'Country'
    config.add_show_field 'collectionLocalId_txt', label: 'Collection ID'
    config.add_show_field 'collectionExtent_txt', label: 'Extent'
    config.add_show_field 'collectionContentTypes_txt', label: 'Content types', link_to_search: 'collectionContentTypesFacet'
    config.add_show_field 'collectionFormats_txt', label: 'Formats', link_to_search: 'collectionFormatsFacet'
    config.add_show_field 'collectionCarrierTypes_txt', label: 'Carrier types'
    ...
    # except in the relevancy case). Sort fields cannot include multivalued fields.
    #config.add_sort_field 'score desc, pub_date_sort desc, title_sort asc', label: 'relevance'
    #config.add_sort_field 'pub_date_sort desc, title_sort asc', label: 'year'
    #config.add_sort_field 'author_sort asc, title_sort asc', label: 'author'
    #config.add_sort_field 'title_sort asc, pub_date_sort desc', label: 'title'
    config.add_sort_field 'score desc, collectionTitle_txt asc', label: 'Relevance'
    config.add_sort_field 'collectionTitle_txt asc', label: 'Title'
